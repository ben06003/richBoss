...
class QRCodeVC: UIViewController, AVCaptureMetadataOutputObjectsDelegate ,UIAlertViewDelegate {
            ...
            _ = Brook_LinkHTTP().link( _httpMethod: .get, _returnType: .Data, _url: _imgURL, _alertShow: true, _testSpeedBool: false,
               ...
               _completefFunc: { (_data) in
                    ...
                    if self._img != nil {
                        ...
                        self._img.center = CGPoint(x: self.view.center.x, y: self.originY + 70)
    ...
    func fromCamera(_completeFunc:@escaping ((String)->())) {
        do{
            ...
            self.output.metadataObjectTypes = [AVMetadataObject.ObjectType.qr,AVMetadataObject.ObjectType.aztec,AVMetadataObject.ObjectType.code39,AVMetadataObject.ObjectType.code93,AVMetadataObject.ObjectType.code128,AVMetadataObject.ObjectType.code39Mod43,AVMetadataObject.ObjectType.face,AVMetadataObject.ObjectType.upce,AVMetadataObject.ObjectType.pdf417,AVMetadataObject.ObjectType.ean8,AVMetadataObject.ObjectType.ean13,AVMetadataObject.ObjectType.itf14,AVMetadataObject.ObjectType.interleaved2of5,AVMetadataObject.ObjectType.dataMatrix]
            ...
            */
            ...
            _tips.frame.size = CGSize(width: scanSize.width, height: self.originY + 30)
            ...
            _cancelBtn.frame.origin = CGPoint(x: 0, y: self.originY + 30)
            _cancelBtn.backgroundColor = UIColor.clear
            _cancelBtn.setTitle( "取消", for: UIControl.State.normal)//普通狀態下的文字
